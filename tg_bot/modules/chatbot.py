...
def check_message(bot: Bot, message):
    ...
    if message.text.lower() == "Amaterasu":
        return True
    if reply_msg:
...
__help__ = """
Chatbot utilizes the CoffeeHouse API and allows Amaterasu to talk back making your chat more interactive.


In future we might make it open for any chat and controllable by group admins.

Powered by CoffeeHouse (https://coffeehouse.intellivoid.net/) from @Intellivoid
Commands: These only work for Amaterasu Staff users. 
